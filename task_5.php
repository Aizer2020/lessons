            ...
            <div class="col-md-6">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        ...
                        <?php foreach($person as $items) :?>
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                            <img src="<?=$items['img']?>" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                    <?=$items['name']?>
                                    ...
                                    <a href="<?=$items['href']?>" class="text-info fs-sm" target="_blank"><?=$items['email']?></a> -
